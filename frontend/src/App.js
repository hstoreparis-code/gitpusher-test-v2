            ...
            <CardContent className="p-5 sm:p-6 relative z-10">
              <div className="flex items-start sm:items-center gap-4 sm:gap-6">
                ...
                <div className="flex flex-col gap-2 flex-1 min-w-0 pt-3 sm:pt-0">
                  ...
                  <div className="flex items-center gap-2">
                    {((user?.plan || '').toLowerCase() === 'premium' || (user?.plan || '').toLowerCase() === 'business') ? (
                      <div className="flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-3 rounded-full bg-gradient-to-r from-violet-500/20 to-purple-500/20 border border-violet-400/40">
                        <span className="text-xl sm:text-2xl">✨</span>
                        <span className="text-sm sm:text-base font-semibold text-violet-300">Accès illimité</span>
                      </div>
                    ) : credits != null && credits <= 2 ? (
