          ...
          >
            ...
            <div className="flex flex-col leading-tight text-left">
              <span className="text-[17px] md:text-[19px] font-semibold tracking-tight">
                Git<span className="bg-gradient-to-r from-cyan-400 to-cyan-600 bg-clip-text text-transparent">Pusher</span><span className="bg-gradient-to-r from-cyan-400 to-cyan-600 bg-clip-text text-transparent text-[13px] md:text-[15px] ml-0.5">.AI</span>
              </span>
      ...
      <main className="flex-1">
        <div className="w-full max-w-4xl mx-auto px-4 py-8 grid grid-cols-1 gap-12 items-start">
          <div className="space-y-4 sm:space-y-8 text-center lg:text-left">
            ...
            <p className="text-xs sm:text-sm text-cyan-200/70 font-medium max-w-2xl mx-auto lg:mx-0 mt-1 lg:-mt-12">
